...
def sentenceInList(possible, string): 
	temp = []

	# This gives us the words, but not in order. We must return them in the order
	# given to us.
...
print(sentenceInList(["quick", "brown", "the", "fox"], "thequickbrownfox"))
print(sentenceInList(["bed", "bath", "bedbath", "and", "beyond"], "bedbathandbeyond"))